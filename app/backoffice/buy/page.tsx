...
export default function Page() {
    ...
    const fetchData = async () => {
        try {
            const respone = await axios.get(`${config.apiUrl}/buy/list`);
    ...
    return(
        <div>
            ...
            <Modal title="เพิ่มรายการ" isOpen={isOpen} onClose={handleCloseModal}>
                ...
                <div className="mt-2">เบอร์โทรศัพท์ลูกค้า</div>
                <input type="text" value={customerPhone} onChange={(e) => setCustomerPhone(e.target.value)} />
                <div className="mt-2">ที่อยู่ลูกค้า</div>
                ...
                <div className="mt-2">
                    <button className="btn" onClick={handleSave}>
                        <i className="fa-solid fa-save mt-2"></i>
                        บันทึก
                    </button>
                </div>
            </Modal>
